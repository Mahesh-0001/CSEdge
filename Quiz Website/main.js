let quizData =[
    ...
    {
        question: "National Heritage Animal?",
        options: ["Cow", "Elephant", "Horse", "Goat"],
        correct: "Elephant",
    },
    {
        question: "National Flower?",
        options: ["Lily", "Tulips", "Lotus", "Rose"],
        correct: "Lotus",
    },
    {
        question: "National River?",
        options: ["Ganga", "Yamuna", "Kaveri", "Brahmaputra"],
        correct: "Ganga",
    },
    {
        question: "National Friut?",
        options: ["Watermelon", "Mango", "Apple", "Orange"],
        correct: "Mango",
    },
];
